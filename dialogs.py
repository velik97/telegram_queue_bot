...
pre_call = "Приготовься, человека перед тобой уже позвали"

call = "Ура, наконец-то твой черед!"

goodbye_respond = "До встречи!\nВозвращайся как можно скорее, а то мне тут скучно..."

#Predictions responds
cant_predict_respond = "Пока сложно сказать, еще никто не прошел"

def predict_respond (minutes):
	return "Такс, ждать еще примерно " + minutes + " минут"